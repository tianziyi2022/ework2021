...
public class StudentSpring2021ServiceImpl extends ServiceImpl<StudentSpring2021Mapper, StudentSpring2021> implements IStudentSpring2021Service {
    ...
    public List<StudentSpring2021> getAllInfo() {
        QueryWrapper<StudentSpring2021> queryWrapper = new QueryWrapper<>();
        queryWrapper.lambda();
        List<StudentSpring2021> studentSpring2021s = studentSpring2021Mapper.selectList(queryWrapper);
        if(studentSpring2021s.isEmpty()){
            throw new BizException("查询失败，结果为空");
        }
        return studentSpring2021s;
    }
}
